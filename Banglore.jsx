...
//   const [y, setAdventures] = useState([]);
...
//       <h2 style={{color:"black"}}>This are the places in {cityName.charAt(0).toUpperCase()+cityName.slice(1)}</h2>
//         <div className="adventuregrid">
//           {y.map((res) => (
//             <div key={res.id} className="adventurecard">
//               <img src={res.image} alt={res.name} className="adventureimg" />
//               <h3>{res.name}</h3>
